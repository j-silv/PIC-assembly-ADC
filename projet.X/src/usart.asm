...
TEST_END_OF_PROMPT_MSG
    ...
    lgoto        PROMPT_MSG_SENT

TEST_TXIF
    btfss       PIR1, TXIF        ; test if the TX_REG is empty
    lgoto        TEST_TXIF         ; sinon, attendre
